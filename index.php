...
<html>
	<head>
		...
		<title>Skillets for Breakfast, Brunch and  Lunch Naples and Bonita Springs, Florida</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://skilletsrestaurants.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-bars ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Menu</a></div>
				</div>    
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-navigation ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Locations</a></div>
				</div>         				
		
		  </div>
		  <h2>Good food made from scratch!</h2>
            <p>The secret to our great food is no secret. We simply cook with the finest ingredients money can buy, make everything on our menu from scratch and cut no corners. What gets the raves? Our thick cut smokehouse bacon. Our incredible, enormous sourdough waffle. Freshly squeezed orange juice served in frosty beer mugs. Ethereal egg white omelettes that literally float off the plate. Nutritious, yet fluffy whole wheat pancakes. Homemade bread, baked daily in our hearth ovens. 
            Tender crepes, Chicago style blintzes, Panini’s griddled with rosemary herb bread. Mountains of fresh fruit. Truly old fashioned, thick, slow cooked oatmeal porridge. Freshly roasted and brewed Guatemalan coffee direct from the plantation.Visit our warm, pine accented dining rooms, meet our friendly servers—see for yourself why Skillets lives by the motto “Breakfast and Lunch with Flair!”</p>
